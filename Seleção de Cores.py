...
l_green = Label(frame_direita, text='Green', width=7, bg=cor1, fg='green', anchor='nw',
...
l_blue = Label(frame_direita, text='Blue', width=7, bg=cor1, fg='blue', anchor='nw',
               font=("Time New Roman", 12, "bold"))
...
# botao copiar
b_copiar = Button(frame_baixo, command=onClick, text='Copiar a cor', bg=cor1, font=("Ivy", 8, "bold"), relief=RAISED,
                  overrelief=RIDGE)
